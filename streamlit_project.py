...
st.markdown(
    ...
    body {
        background: #f7f9fc;  /* Fond clair et neutre pour une ambiance moderne */
    }
...
if page == pages[0]:
    ...
    st.markdown(
        """
        <style>
        /* Animation pour les boutons sur la page 3 */
        div.stButton > button {
    ...
    with st.form("my_form"):
        release_date = st.text_input("Date de sortie (YYYY-MM-DD): ", value="2017-12-15")
        ...
        popularity = st.number_input("Note de popularité (ex. 5000):", min_value=0.0, value=8000.0)
